...
//helper functions
// respondWithError responsible for passing to the http layer error codes
// respondWithJSON reponsible for creating the JSONs th must be answered for each request
